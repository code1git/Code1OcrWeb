package com.code1system.web.config;
...
@Configuration
@MapperScan(basePackages="com.code1system.web.dbmapper1",sqlSessionFactoryRef="db1SqlSessionFactory")/*멀티DB사용시 mapper클래스파일 스켄용 basePackages를 DB별로 따로설정*/
@EnableTransactionManagement
public class DBConfigMaria {
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier("db1DataSource") DataSource db1DataSource, ApplicationContext applicationContext) throws Exception{
		...
		sessionFactory.setMapperLocations(applicationContext.getResources("classpath:mybatis/db1/*.xml")); //쿼리작성용 mapper.xml위치 설정.
